...
| Skills | `.claude/skills/aeo-optimization/`, `technical-seo/`, `content-seo/`, `demand-signals/`, `local-seo/`, `schema-authoring/`, `llms-txt/`, `aeo-plan-structure/`, `qas-checklist/`, `citation-tracking/` |
